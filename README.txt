...
"SWING"      敵指定なし、2〜(STR÷3)+1の間のランダムな値回数だけ、ランダムな生きている敵に１ダメージ与える。
             (一回一回ランダムな敵が選ばれる)
...
1/3の確率で
ダメージ : 4〜(プレイヤーレベル+8+3)の間のランダムな値をHPに与えてくる。
1/3の確率で
ダメージ : 4〜(プレイヤーレベル+8+3)の間のランダムな値をSTRに与えてくる。
          (STRが0だった場合HPにダメージが入る)

1/3の確率で
ヒール :  4〜(プレイヤーレベル+8+3)の間のランダムな値をハツネツ自身のHP回復する。

・もげぞう

1/3の確率で
ダメージ : 6〜(プレイヤーレベル+10+5)の間のランダムな値をHPに与えてくる。
1/3の確率で
ダメージ : 6〜(プレイヤーレベル+10+5)の間のランダムな値をプレイヤーの全てのステータスに与えてくる。

1/3の確率で
ダメージ : 6〜(プレイヤーレベル+10+5)の間のランダムな値をAGIに与えてくる。
